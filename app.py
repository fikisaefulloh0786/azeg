...
db = connector.connect(
    cnx = mysql.connector.connect(user="bisminna", password="Aminku1ya", host="bismillahya.mysql.database.azure.com", port=3306, database="ecommerce", ssl_ca="{ca-cert filename}", ssl_disabled=False)
)
db_config = {
    'host': 'localhost',
    'user': 'root',
